...
public interface IVector3Math<N extends Number, VO extends IVector3<N> & IVector3Math<N, VO, Q>, Q extends IQuaternion<? extends Number>> extends IVector3<N> {
	...
	default public VO pow(IVector3<? extends Number> vec) { return this.copy().powI(vec); }
	default public VO pow(N x, N y, N z) { return this.copy().powI(x, y, z); }
	default public VO pow(N n) { return this.copy().powI(n); }
	public VO powI(IVector3<? extends Number> vec);
	public VO powI(N x, N y, N z);
	public VO powI(N n);

	default public VO root(IVector3<? extends Number> vec) { return this.copy().rootI(vec); }
	default public VO root(N x, N y, N z) { return this.copy().rootI(x, y, z); }
	default public VO root(N n) { return this.copy().rootI(n); }
	public VO rootI(IVector3<? extends Number> vec);
	public VO rootI(N x, N y, N z);
	public VO rootI(N n);
